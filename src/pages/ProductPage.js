...
export default function ProductPage({products, languageVersion, onAddProduct, onRate = f => f, user, canAddProductToCart = f => true}) {
    const {id} = useParams();
    ...
    return <>
        <div className="p-4 sm:ml-64">
            <Product product={product[0]} languageVersion={languageVersion} onAddProduct={onAddProduct}
                     onRate={onRate} canAddProductToCart={canAddProductToCart}/>
